...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for(int i = 0; i < v; i++) {
			outNeighbours = getNeighbors(i);
			inNeighbours = getInNeighbors(i);
			sequence.add(outNeighbours.size() + inNeighbours.size());
		}
	...
	public static void main (String[] args) {
		...
		GraphLoader.createIntersectionsFile("data/maps/panchkula.map", "data/intersections/panchkula.intersections");
